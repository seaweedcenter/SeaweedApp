...
//	}
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			Button button_factory = (Button) rootView.findViewById(R.id.button_to_factory);
	        button_factory.setOnClickListener(new View.OnClickListener() {

				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent i = new Intent(v.getContext(),ItemListActivity.class);
                    startActivity(i);
				}
	        });
	        
	      //Button "To the shop"
			Button button_shop = (Button) rootView.findViewById(R.id.button_to_shop);
	      ...
	      //Button "To the reports"
			Button button_reports = (Button) rootView.findViewById(R.id.button_report);
